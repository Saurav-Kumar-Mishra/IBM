  ...
  useEffect(() => {
    if (formik.values.subCategory) {
      const selectedSubCategory = subCategories.find(
        (subCat) => subCat._id === formik.values.subCategory
      );
      setSubSubCategories(
  ...
  return (
    <div className=" w-full max-w-4xl mx-auto bg-gray-200 p-2 rouded-lg ">
      <form
        ...
        className="p-4 flex flex-col gap-4 min-w-96"
      >
        ...
        <button
          type="submit"
          className="bg-blue-600 text-white rounded-md h-10 flex items-center justify-center"
        >
          Submit
        </button>
      </form>
